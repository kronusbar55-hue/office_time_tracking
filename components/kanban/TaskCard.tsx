            ...
            <div className="flex flex-col gap-3">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-[10px] font-bold text-text-secondary uppercase tracking-tighter">{task.key}</span>
                    </div>
                    <div className="h-6 w-6 rounded-full bg-bg-secondary border border-border-color flex items-center justify-center overflow-hidden">
                        {task.assignee ? (
                            <img
                            ...
                            <div className="h-full w-full bg-card-bg flex items-center justify-center">
                ...
                <div className="flex items-center justify-between pt-2 mt-1 border-t border-border-color">
                    <div className="flex items-center gap-3">
                        <div className="flex items-center gap-1 text-text-secondary group-hover:text-text-secondary transition-colors">
                    ...
                    <div className="flex items-center gap-2">
                        {task.storyPoints > 0 && (
                            <span className="flex h-5 w-5 items-center justify-center rounded-full bg-accent/20 border border-accent/30 text-[9px] font-black text-text-primary tabular-nums">
                                {task.storyPoints}
                            </span>
                        )}
                        <div className="h-6 w-6 rounded-lg bg-bg-secondary border border-border-color flex items-center justify-center">
