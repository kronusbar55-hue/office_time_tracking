  ...
  if (loading) {
    return (
      <div className="space-y-3">
        <div className="h-6 w-1/3 animate-pulse rounded bg-border-color dark:bg-bg-secondary/40" />
        <div className="h-4 w-2/3 animate-pulse rounded bg-border-color dark:bg-bg-secondary/40" />
      </div>
    );
  }
