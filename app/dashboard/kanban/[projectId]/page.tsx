                ...
                <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    <div className="flex items-center gap-4 min-w-0">
                        ...
                        <div className="min-w-0">
                            <h1 className="truncate text-2xl font-black text-text-primary tracking-tighter uppercase">{project?.name || 'Kanban'} <span className="text-accent">Board</span></h1>
                            <div className="flex items-center gap-2 mt-1">
                                <span className="truncate text-[10px] font-bold text-text-secondary uppercase tracking-widest">{project?.clientName || 'Active Project Board'}</span>
                            </div>
                        </div>
                    </div>

                    <div className="flex flex-wrap items-center gap-2">                        <button className="flex items-center gap-2 px-4 py-2 rounded-xl bg-hover-bg border border-border-color text-text-secondary hover:bg-hover-bg transition-all text-sm font-bold opacity-60">
                            <Users size={16} />
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                        ...
                        <div className="flex flex-wrap items-center gap-3">
                            ...
                            <div className="flex flex-wrap items-center gap-2 -space-x-1">                                <button
                                ...
                                {loadingMembers ? (
                                    <div className="flex items-center gap-2 ml-2">
                                        <div className="h-8 w-8 rounded-full bg-border-color animate-pulse" />
                                        <div className="h-8 w-8 rounded-full bg-border-color animate-pulse" />
                                        <div className="h-8 w-8 rounded-full bg-border-color animate-pulse" />
                                    </div>
                                ) : (
