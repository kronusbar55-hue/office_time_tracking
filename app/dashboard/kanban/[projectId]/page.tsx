                ...
                <div className="flex flex-col gap-6 p-8 pb-4 border-b border-white/5 bg-slate-900/20 backdrop-blur-md">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <button className="flex items-center gap-2 px-6 py-2 rounded-xl bg-accent text-white hover:bg-accent-hover transition-all text-sm font-black shadow-lg shadow-accent/20">
                                <Plus size={18} />
