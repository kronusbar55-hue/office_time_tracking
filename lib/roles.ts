...
export const NAV_CONFIG: Array<{
  ...
  { label: "Analytics", href: "/dashboard/admin/analytics", icon: "dashboard", allowed: [ROLES.ADMIN] },
  { label: "Analytics", href: "/dashboard/manager/analytics", icon: "reports", allowed: [ROLES.MANAGER] },
  ...
  { label: "Technologies", href: "/technologies", icon: "tech", allowed: [ROLES.ADMIN, ROLES.HR] },
  { label: "Projects", href: "/projects", icon: "projects", allowed: [ROLES.ADMIN, ROLES.MANAGER, ROLES.EMPLOYEE] },
  { label: "Project Update", href: "/project-updates", icon: "projects", allowed: [ROLES.ADMIN, ROLES.MANAGER] },
